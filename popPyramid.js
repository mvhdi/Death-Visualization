function pyramidBuilder(data, target, options) {
    ...
    var styleSection = d3.select('body').append('style')
    ...
    var region = d3.select('body').append('svg')
        .attr('width', w_full)
        .attr('height', h_full);
    ...
    leftBarGroup.selectAll('.bar.left')
        ...
        .attr('width', function(d) {
            return xScale(percentage(10.5*d.male));
        })
        ...
        .on("mouseover", function(d) {
            ...
            tooltipDiv.html("<strong>Males Age " + d.age + "</strong>" +
                    "<br />  Percent Alive: " + prettyFormat(d.male))
    ...
    rightBarGroup.selectAll('.bar.right')
        ...
        .attr('width', function(d) {
            return xScale(percentage(10.5*d.female));
        })
        .attr('height', (yScale.range()[0] / data.length) - margin.middle / 2)
        .on("mouseover", function(d) {
            tooltipDiv.transition()
            ...
            tooltipDiv.html("<strong> Females Age " + d.age + "</strong>" +
                    "<br />  Percent Alive: " + prettyFormat(d.female) )
                .style("left", (d3.event.pageX) + "px")
                .style("top", (d3.event.pageY - 28) + "px");
        })
        .on("mouseout", function(d) {
